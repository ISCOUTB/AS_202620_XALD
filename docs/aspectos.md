...
|---|---|---|---|---|---|---|---|---|
| **A-01** | Recepción y procesamiento de información vía SMS / Notificaciones bancarias | [RT-04](arc42/arc42-template-EN.md#architecture-constraints) | [C1](c4/c4.md) | [ESC-03](arc42/arc42-template-EN.md#esc-03--incorporación-de-una-nueva-entidad-bancaria) | [0002](adr/0002-parsing-hibrido.md) · [0003](adr/0003-restriccion-os.md) | https://github.com/ISCOUTB/AS_202620_XALD/blob/experimental/XALDAPP/parser/src/main/java/Parser.kt | *Pendiente* | *Pendiente* |
